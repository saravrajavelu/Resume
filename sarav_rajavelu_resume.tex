...
\section{Skills}
  \resumeSubHeadingListStart
    \resumeSubItem{Languages}{Python (scikit-learn, NumPy, SciPy, Pandas), R, SQL, SQL Server, C++}
    \resumeSubItem{Technologies}{R Studio, Excel, SQL Server Integration Services, Informatica PowerCenter}
    ...
    \resumeSubItem{Certifications}{\href{https://www.coursera.org/account/accomplishments/certificate/A6KTKA55F74V}{Neural Networks and Deep Learning}, \href{https://www.coursera.org/account/accomplishments/verify/FZX28DSGSW52}{Data Science in Python}  \& R Programming on Coursera}
  \resumeSubHeadingListEnd
...
%% Emplay Analytics 
    \resumeSubheading
      ...
      {Data Scientist}{Jun. 2016 - Jun. 2017}
      \resumeItemListStart
	\item
          {Developed recommendation algorithms for supporting sales representatives in achieving their goals.}
%       {Developed recommendation algorithms to help sales representatives predictably meet their sales quota.}
        \item
{Worked on lead classification, forecasting the probability of sales and performance forecasting of sales teams. Improved lead classification accuracy by 11\% by scraping industry trends from external sources.}
	%\item
          %{Created and maintained the R Library of the company's algorithms that were used in product.}
      \resumeItemListEnd
...
%% OhioState
    \resumeSubheading
      ...
      \resumeItemListStart
        \item{CSE 2111 Spreadsheets and Databases}
	{Instructor for the undergraduate course that teaches spreadsheet and database modeling, programming concepts and techniques to solve business related problems.}
...
%% Sentiment in Football Tweets
		\projectSubheading
 		{Sentiment in Football Tweets}{Jun. 2016 - Jul. 2016}
			\resumeItemListStart
%				\item
%				{Developed an algorithm to use the sentiment in Tweets relating to a football game.}
%				\item
%				{The sentiment score at each minute of the game was calculated by aggregating all Tweets extracted at that minute, using a sentiment dictionary to assign a score to each Tweet.}
				\item
				{Calculated the sentiment score at each minute, using it to plot a ‘sentiment score versus game time’ graph to study the correlation between spikes in the graph with an event in the game.}
		      \resumeItemListEnd
 		...
 		{Exploratory Data Analysis \& Classification }{}
			\resumeItemListStart
				\resumeItemLink{https://github.com/saravrajavelu/LogisticRegression}{Logistic Regression}
    				 {Built using NumPy to predict whether a student will be admitted to a university or not.}
				...
				\resumeItemLink{https://github.com/saravrajavelu/Adult-Income-Analysis}{Census Income}
