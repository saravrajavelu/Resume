...
\section{Skills}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Certifications}{R Programming \& \href{https://www.coursera.org/account/accomplishments/verify/FZX28DSGSW52}{Data Science in Python} - Statement of Accomplishment with Distinction, Coursera}
  \resumeSubHeadingListEnd
...
%% Emplay Analytics 
	...
	\item
        ...
        \item
{Worked on lead classification, forecasting the probability of sales and performance forecasting of sales teams. Improved lead classification accuracy by 11\% by scraping industry trends from Yahoo finance.}
	%\item
